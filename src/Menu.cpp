...
void	Menu::initMaps()
{
	_maps.push_back({"media/map-t.jpg", "Map T", "media/mapT.txt", 15, 15, 2});
	_maps.push_back({"media/random.png", "Random", "empty", 10, 10, 6});
	_maps.push_back({"media/map-x.jpg", "Map X", "media/mapX.txt", 15, 15, 2});
	_maps.push_back({"media/map-m.png", "Map M", "media/mapM.txt", 15, 15, 2});
	_sizeMap = 10;
}
...
//	_item.push_back(std::unique_ptr<IEntity>(new MenuItem(Entity::LABEL, 18, "Wall Pass", SCREEN_WIDTH - 350, 600, 250, 50)));
	...
	_item.push_back(std::unique_ptr<IEntity>(new MenuItem(Entity::LABEL, 45, "Shield", SCREEN_WIDTH - 350, 800, 250, 50)));
	...
	if (_randomMode == true)
		...
		_item.push_back(std::unique_ptr<IEntity>(new MenuItem(Entity::LABEL, 29,
		std::to_string(_mapW) + "x" + std::to_string(_mapH), 915, 400, 130, 100)));
}
